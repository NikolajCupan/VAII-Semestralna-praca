                    ...
                    <div class="clanokPrvyFooter card-footer text-muted d-flex justify-content-between">
                        <div class="float-left">
                            <?php if ($auth->isLogged()) { ?>
                                <?php if ($article->hasLikeFromUser($auth->getLoggedUserId())) { ?>
                                    <a class="clanokLiked clanokLikes" href="?c=article&a=cancelLike&articleId=<?php echo $article->getId() ?>">🖤 <?php echo $article->getLikesCount() ?> likes</a>
                                <?php } else { ?>
                                    <a class="clanokToBeLiked clanokLikes" href="?c=article&a=like&articleId=<?php echo $article->getId() ?>">🤍 <?php echo $article->getLikesCount() ?> likes</a>
                                <?php } ?>
                            <?php } else { ?>
                        ...
                        <div class="float-right">
                            <?php if (getHasPermissionToManage($article, $auth)) { ?>
                                <a style="text-decoration: none" href="?c=article&a=modify&articleId=<?php echo $article->getId() ?>">
                                ...
                                <a href="#" data-id="<?php echo $article->getId() ?>" class="deleteArticle card-link" data-bs-toggle="modal" data-bs-target="#modal">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a name="articleId" id="articleId" href="" class="btn btn-danger">Zmazať</a>
            </div>
        </div>
    </div>
</div>